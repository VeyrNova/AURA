...
The default `main` branch remains the public baseline; the validated development snapshot above has **not yet been merged into main**.
...
The R21 code is validated on the sanitized validation branch; the default `main` branch remains the public baseline and has not received the runtime implementation.
...
R21 remains the validated startup-performance baseline. R30 is validated on the sanitized validation branch; the default `main` branch remains the public baseline and does not receive this runtime code change.
<!-- AURA_R30_STATUS_END -->
