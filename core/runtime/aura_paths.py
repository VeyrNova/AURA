...
class AuraPaths:
    ...
    def resolve(
        ...
        *,
        ...
        # P0.8.5.2.2 — portable UI precedence.
        # Installed mode may use the machine-local current.json locator.
        # Portable mode must never be hijacked by an old installed locator.
        ui = None
