...
def main():
    ...
    print("=" * 100)
    # AURA_V0863_METADATA_INVARIANT_BEGIN
    __import__('runpy').run_path(__import__('os').path.normpath(__import__('os').path.join(__import__('os').path.dirname(__file__),'..','tests','invariants','test_metadata_contract_v095.py')),run_name='__main__')
    # AURA_V0863_METADATA_INVARIANT_END
