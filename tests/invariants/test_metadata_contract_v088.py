...
REPORT = ROOT / "ci" / "reports" / "metadata_invariant_v088.json"
...
result = {
    "schema": "aura.ci.metadata-invariant.v088.v1",
    "pass": failed == 0,
...
print("METADATA INVARIANT V088: PASS" if result["pass"] else "METADATA INVARIANT V088: FAIL")
