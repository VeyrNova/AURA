...
REPORT = ROOT / "ci" / "reports" / "metadata_invariant_v087.json"
...
result = {
    "schema": "aura.ci.metadata-invariant.v087.v1",
    "pass": failed == 0,
...
print("METADATA INVARIANT V087: PASS" if result["pass"] else "METADATA INVARIANT V087: FAIL")
