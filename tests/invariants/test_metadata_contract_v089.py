...
REPORT = ROOT / "ci" / "reports" / "metadata_invariant_v089.json"
...
result = {
    "schema": "aura.ci.metadata-invariant.v089.v1",
    "pass": failed == 0,
...
print("METADATA INVARIANT V089: PASS" if result["pass"] else "METADATA INVARIANT V089: FAIL")
