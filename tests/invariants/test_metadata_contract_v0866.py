...
REPORT = ROOT / "ci" / "reports" / "metadata_invariant_v0866.json"

EXPECTED_VERSION = "0.8.6.6"
...
result = {
    "schema": "aura.ci.metadata-invariant.v0866.v1",
    "pass": failed == 0,
...
print("METADATA INVARIANT V0866: PASS" if result["pass"] else "METADATA INVARIANT V0866: FAIL")
