...
REPORT = ROOT / "ci" / "reports" / "metadata_invariant_v092.json"
...
result = {
    "schema": "aura.ci.metadata-invariant.v092.v1",
    "pass": failed == 0,
...
print("METADATA INVARIANT V092: PASS" if result["pass"] else "METADATA INVARIANT V092: FAIL")
