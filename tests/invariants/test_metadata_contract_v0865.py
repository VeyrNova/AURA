...
REPORT = ROOT / "ci" / "reports" / "metadata_invariant_v0865.json"

EXPECTED_VERSION = "0.8.6.5"
...
result = {
    "schema": "aura.ci.metadata-invariant.v0865.v1",
    "pass": failed == 0,
...
print("METADATA INVARIANT V0865: PASS" if result["pass"] else "METADATA INVARIANT V0865: FAIL")
