...
PARENT_CERT = ROOT / "AURA_V0_8_9_FINAL_CERTIFICATE.json"
...
checks.append(("v0.8.9 certified parent", cert.get("status") == "CERTIFIED"))
...
routes = [
    ...
    ("MissionEngine reverified v0.9.0", ROOT / "tests" / "invariants" / "test_mission_engine_v088.py", ()),
    ("Action Receipts reverified v0.9.0", ROOT / "tests" / "invariants" / "test_action_receipts_v089.py", ()),
    ("Integration Architecture v0.9.0", ROOT / "tests" / "invariants" / "test_integration_architecture_v090.py", ()),
