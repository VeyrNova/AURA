...
PARENT_CERT = ROOT / "AURA_V0_9_0_FINAL_CERTIFICATE.json"
...
cert = json.loads(PARENT_CERT.read_text(encoding="utf-8-sig"))
checks.append(("v0.9.0 certified parent", cert.get("status") == "CERTIFIED"))
...
routes = [
    ...
    ("MissionEngine reverified v0.9.1", ROOT / "tests" / "invariants" / "test_mission_engine_v088.py", ()),
    ("Action Receipts reverified v0.9.1", ROOT / "tests" / "invariants" / "test_action_receipts_v089.py", ()),
    ("Integration Architecture reverified v0.9.1", ROOT / "tests" / "invariants" / "test_integration_architecture_v090.py", ()),
    ("Email Provider v0.9.1", ROOT / "tests" / "invariants" / "test_email_provider_v091.py", ()),
