...
REPORT = ROOT / "ci" / "reports" / "metadata_invariant_v0867.json"

EXPECTED_VERSION = "0.8.6.7"
...
result = {
    "schema": "aura.ci.metadata-invariant.v0867.v1",
    "pass": failed == 0,
...
print("METADATA INVARIANT V0867: PASS" if result["pass"] else "METADATA INVARIANT V0867: FAIL")
