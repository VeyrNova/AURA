...
REPORT = ROOT / "ci" / "reports" / "metadata_invariant_v091.json"
...
result = {
    "schema": "aura.ci.metadata-invariant.v091.v1",
    "pass": failed == 0,
...
print("METADATA INVARIANT V091: PASS" if result["pass"] else "METADATA INVARIANT V091: FAIL")
