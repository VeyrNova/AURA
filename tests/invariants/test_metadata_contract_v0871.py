...
REPORT = ROOT / "ci" / "reports" / "metadata_invariant_v0871.json"

EXPECTED_VERSION = "0.8.7.1"
...
result = {
    "schema": "aura.ci.metadata-invariant.v0871.v1",
    "pass": failed == 0,
...
print("METADATA INVARIANT V0871: PASS" if result["pass"] else "METADATA INVARIANT V0871: FAIL")
