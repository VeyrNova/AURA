...
REPORT = ROOT / "ci" / "reports" / "metadata_invariant_v0864.json"

EXPECTED_VERSION = "0.8.6.4"
...
result = {
    "schema": "aura.ci.metadata-invariant.v0864.v1",
    "pass": failed == 0,
...
print("METADATA INVARIANT V0864: PASS" if result["pass"] else "METADATA INVARIANT V0864: FAIL")
