...
PARENT = ROOT / "AURA_V0_9_2_2_FINAL_CERTIFICATE.json"
...
routes = [
    ...
    (
        "source-driven UI",
        ROOT / "tools" / "ui_source_build_v0865.py",
        ("--check",),
    ),
]
