...
REPORT = ROOT / "ci" / "reports" / "metadata_invariant_v0868.json"

EXPECTED_VERSION = "0.8.6.8"
...
result = {
    "schema": "aura.ci.metadata-invariant.v0868.v1",
    "pass": failed == 0,
...
print("METADATA INVARIANT V0868: PASS" if result["pass"] else "METADATA INVARIANT V0868: FAIL")
