...
REPORT = ROOT / "ci" / "reports" / "metadata_invariant_v090.json"
...
result = {
    "schema": "aura.ci.metadata-invariant.v090.v1",
    "pass": failed == 0,
...
print("METADATA INVARIANT V090: PASS" if result["pass"] else "METADATA INVARIANT V090: FAIL")
