...
PARENT = ROOT / "AURA_V0_9_3_FINAL_CERTIFICATE.json"
def run(path, *args):
...
cert = json.loads(PARENT.read_text(encoding="utf-8-sig"))
checks=[("v0.9.3 certified parent",cert.get("status")=="CERTIFIED" and cert.get("completion_percent")==100 and cert.get("version")=="0.9.3")]
routes=[
