...
CERT871 = ROOT / "AURA_V0_8_7_1_FINAL_CERTIFICATE.json"
...
cert = json.loads(CERT871.read_text(encoding="utf-8-sig"))
checks.append(("v0.8.7.1 certified parent", cert.get("status") == "CERTIFIED"))
