...
REPORT = ROOT / "ci" / "reports" / "metadata_invariant_v09221.json"

EXPECTED_VERSION = "0.9.2.2.1"
...
result = {
    "schema": "aura.ci.metadata-invariant.v09221.v1",
    "pass": failed == 0,
...
print("METADATA INVARIANT V0921: PASS" if result["pass"] else "METADATA INVARIANT V0921: FAIL")
