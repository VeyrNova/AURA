...
PARENT_CERT = ROOT / "AURA_V0_8_8_FINAL_CERTIFICATE.json"
...
checks.append(("v0.8.8 certified parent", cert.get("status") == "CERTIFIED"))
...
routes = [
    ...
    ("Action Receipts v0.8.9", ROOT / "tests" / "invariants" / "test_action_receipts_v089.py", ()),
